    ...
    >
      ...
      >
        <div className="text-center text-3xl">
          ...
          <br />
          <span className="text-gray-800 dark:text-white">Used by the leaders.</span>
        </div>
        ...
        <div className="relative mt-7 h-[100px] w-full">
          ...
          >
            {logos.map(({ id, component: Logo, className }) => (
              <div key={id} className={`${className} text-gray-600 dark:text-gray-400`}>
                <Logo />
              </div>
            ))}
          </InfiniteSlider>
      ...
      <div className="relative -mt-32 h-96 w-full overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)]">
        <div className="absolute inset-0 before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom_center,#6366f1,transparent_70%)] dark:before:bg-[radial-gradient(circle_at_bottom_center,#3b82f6,transparent_70%)] before:opacity-40" />
        <div className="absolute -left-1/2 top-1/2 aspect-[1/0.7] z-10 w-[200%] rounded-[100%] border-t border-indigo-200/30 dark:border-blue-500/20 bg-white dark:bg-zinc-900" />
        <Sparkles
          density={1200}
