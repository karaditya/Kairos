...
export function Testimonial() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full max-w-xl mx-auto py-12 px-6"
      style={{ cursor: "none" }}
    ...
    >
      ...
      <motion.div
        className="absolute top-4 right-4 flex items-baseline gap-1 font-mono text-xs"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div className="relative pt-8">
        <AnimatePresence mode="wait">
          <motion.blockquote
            ...
            className="text-lg md:text-xl font-light leading-relaxed tracking-tight text-foreground"
          >
            ...
            <div className="relative w-10 h-10">
              ...
              {testimonials.map((t, i) => (
                <motion.img
                  ...
                  src={t.avatar}
                  alt={t.author}
                  className="absolute inset-0 w-10 h-10 rounded-full object-cover grayscale hover:grayscale-0 transition-[filter] duration-500"
                  animate={{
        ...
        {/* Progress bar */}
        <div className="mt-10 h-px bg-border relative overflow-hidden">
          <motion.div
